...
public:
    ...
    std::string tool_change(
        GCode& gcodegen, int extruder_id, bool finish_layer, bool local_z_unplanned = false, double local_z_nominal_layer_z = -1.);
...
public:
    GCode()
        ...
        , m_layer_count(0)
        , m_use_layered_for_overlapping_extruders(false)
        , m_layer_index(-1)
        , m_layer(nullptr)
...
private:
    ...
    bool         m_use_layered_for_overlapping_extruders;
